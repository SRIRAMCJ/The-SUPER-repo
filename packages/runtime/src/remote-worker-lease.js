...
export class RemoteWorkerLeaseManager {
  #leases = new Map(); #clock; #ttlMs; #sequence = 0; #fenceSequence = 0;
  ...
  fence(leaseId, reason='worker lost', expectedFencingToken=null) {
    ...
    const next=Object.freeze({...lease,status:'fenced',fencedAt:this.#clock(),fenceReason:String(reason)});this.#leases.set(leaseId,next);return this.#result('fenced',{lease:next});
  }
